...
export default function AddQuizModal({setModal}) {
    ...
    >
      ...
      <>
        ...
        <h1 className='text-2xl mb-10 text-stone-50 font-bold flex'>
          New Quiz <button className='ml-auto text-red-500 text-3xl' onClick={()=>{setModal(false)}}><CgCloseR /></button>
        </h1>
      ...
      <>
        ...
        <div className='flex gap-5 mt-16'>
          <button className='px-2 py-1 w-32 mr-auto rounded bg-green-600' onClick={()=>{addQuiz()}}>Save</button>
